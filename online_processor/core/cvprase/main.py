...
if __name__ == '__main__':
    ...
    path_url = os.path.join(BASE_DIR, 'resources', '智联招聘_郝先生_中文_20190415_1555295349103.doc')
    print(path_url)
    h = CV_main("F:\\workhome\\python\\kb_demo\\online_processor\\resources\\智联招聘_郝先生_中文_20190415_1555295349103.doc")
    data = h.main_prase()
